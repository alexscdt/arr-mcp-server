...
export const searchMovieToolDefinition = {
    name: 'search_movie',
    description: 'Search for a movie by title. Returns a list of matching movies with metadata (title, year, TMDB id, overview, ratings). Use this before add_movie to find the exact tmdbId.',
    inputSchema: {
        type: 'object',
        properties: {
            query: {
...
export async function handleSearchMovie(args) {
    const input = searchMovieInputSchema.parse(args);
...
//# sourceMappingURL=search_movie.js.map