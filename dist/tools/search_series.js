...
export const searchSeriesToolDefinition = {
    name: 'search_series',
    description: 'Search for a TV series by title. Returns a list of matching series with metadata (title, year, TVDB id, overview, network, status). Use this before add_series to find the exact tvdbId.',
    inputSchema: {
        type: 'object',
        properties: {
            query: {
...
export async function handleSearchSeries(args) {
    const input = searchSeriesInputSchema.parse(args);
...
//# sourceMappingURL=search_series.js.map