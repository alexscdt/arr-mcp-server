...
export class PlexClient {
    ...
    async getLibraryContents(sectionKey: string, options?: {
        sort?: string
        limit?: number
        offset?: number
        ...
        if (options?.limit !== undefined) query['X-Plex-Container-Size'] = options.limit
        if (options?.offset !== undefined) query['X-Plex-Container-Start'] = options.offset
    ...
    async getRecentlyAdded(sectionKey?: string, limit: number = 20): Promise<PlexMediaItem[]> {
